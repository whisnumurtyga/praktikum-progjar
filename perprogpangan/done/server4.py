...
def send_file(udp_socket, server_address, file_format):
    if file_format == 3:
        file_path = "dikirim/FilePDF_4.pdf"
    elif file_format == 4:
        file_path = "dikirim/FileJPG_4.jpg"
    elif file_format == 5:
        file_path = "dikirim/FileMP3_4.mp3"
    elif file_format == 6:
        file_path = "dikirim/FileMP4_4.mp4"
...
def recived_file(udp_socket, file_info):
    ...
    destination_folder = "download_server4"
