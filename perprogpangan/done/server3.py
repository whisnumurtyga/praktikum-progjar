...
def send_file(udp_socket, server_address, file_format):
    if file_format == 3:
        file_path = "dikirim_server3/FilePDF_3.pdf"
    elif file_format == 4:
        file_path = "dikirim_server3/FileJPG_3.jpg"
    elif file_format == 5:
        file_path = "dikirim_server3/FileMP3_3.mp3"
    elif file_format == 6:
        file_path = "dikirim_server3/FileMP4_3.mp4"
...
def recived_file(udp_socket, file_info):
    ...
    destination_folder = "download_server3"
