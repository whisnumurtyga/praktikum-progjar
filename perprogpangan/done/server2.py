...
def send_file(udp_socket, server_address, file_format):
    if file_format == 3:
        file_path = "dikirim_server2/FilePDF_2.pdf"
    elif file_format == 4:
        file_path = "dikirim_server2/FileJPG_2.jpg"
    elif file_format == 5:
        file_path = "dikirim_server2/FileMP3_2.mp3"
    elif file_format == 6:
        file_path = "dikirim_server2/FileMP4_2.mp4"
...
def recived_file(udp_socket, file_info):
    ...
    destination_folder = "download_server2"
